...
const AboutPage = () => {
    return ( 
        <Link href={'/'}>
        <div className="h-[60vh] p-8"><h1 className="text-blue-600 text-2xl font-bold "><br /><span className="text-2xl text-black font-bold">About Page is Under Production.</span> Click Here to go back to home page</h1>
